...
namespace DevExpress.XtraRichEdit.Design {
    ...
    public class RepositoryItemRichTextIndentEdit : RepositoryItemBaseSpinEdit {
        ...
        public static void RegisterRichTextIndentEdit() {
            ...
            // TODO: replace image
            Bitmap img = ResourceImageHelper.CreateBitmapFromResources("DevExpress.XtraRichEdit.Bitmaps256.RichTextEdit.bmp", typeof(RepositoryItemRichTextIndentEdit).Assembly);
    ...
    // LP [LicenseProvider(typeof(DevExpress.Utils.About.DXWinLicenseProvider))] //DEMO_REMOVE
#if DEBUGTEST
    [DXToolboxItem(true)]
#else
    [DXToolboxItem(false)]
#endif
    [DevExpress.Licensing.DXLicenseWinForms] //DEMO_REMOVE
